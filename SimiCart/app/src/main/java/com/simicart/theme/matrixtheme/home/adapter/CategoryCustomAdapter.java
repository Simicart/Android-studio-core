...
import com.simicart.theme.matrixtheme.home.fragment.SpotProductTheme1Fragment;
...
public class CategoryCustomAdapter extends BaseAdapter {
    ...
    protected void viewOrderProduct(OrderProduct orderProduct) {
        if (orderProduct.getSpotKey() != null) {
            SpotProductTheme1Fragment fragment = SpotProductTheme1Fragment.newInstance(orderProduct.getSpotKey(), orderProduct.getSpotName(), null, null, null);
