...
public class HomeZThemeAdapterTablet extends BaseAdapter {
	...
	public HomeZThemeAdapterTablet(Context context,
			ArrayList<ZThemeCatalogEntity> list) {
		mContext = context;
...
//		ZThemeCatalogEntity category = mCategories.get(position);
...
//		} else {
//			String url = "";
//			if (category.getType() == ZThemeCatalogEntity.TYPE_CAT) {
//				final Category object = mCategories.get(position);
//				url = object.getCategoryImage();
//			} else {
//				ZThemeSpotEntity object = category.getZThemeSpotEntity();
//				url = object.getImage();
//			}
