...
public class TabDownloadAdapter extends FragmentStatePagerAdapter {
	...
	private void addTitle() {
		mListTitle.add(SimiTranslator.getInstance().translate("Download Availability"));
		mListTitle.add(SimiTranslator.getInstance().translate("Downloading"));
		mListTitle.add(SimiTranslator.getInstance().translate("Downloaded"));
	}
