...
import com.simicart.plugins.storelocator.entity.SpecialObject;
...
public class SpecialDayAdapter extends RecyclerView.Adapter<SpecialDayAdapter.SpecialDayHolder> {
    ...
    public SpecialDayHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(Rconfig.getInstance().layout("plugins_store_locator_item_list_special"), parent, false);
