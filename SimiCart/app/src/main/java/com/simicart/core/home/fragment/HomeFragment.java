...
public class HomeFragment extends SimiFragment {
    ...
    protected ProductListHomeBlock mProductListHomeBlock;
    protected ProductListHomeController mProductListHomeController;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mProductListHomeBlock = new ProductListHomeBlock(ll_spotproduct, context);
        mProductListHomeBlock.initView();
        if (null == mProductListHomeController) {
            mProductListHomeController = new ProductListHomeController();
            mProductListHomeController.setDelegate(mProductListHomeBlock);
            mProductListHomeController.onStart();
        } else {
            mProductListHomeController.setDelegate(mProductListHomeBlock);
            mProductListHomeController.onResume();
        }
