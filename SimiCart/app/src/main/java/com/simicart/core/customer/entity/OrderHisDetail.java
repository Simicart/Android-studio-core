...
public class OrderHisDetail extends SimiEntity {
    ...
    public AddressEntity getShipping_address() {
    ...
    public void setShipping_address(AddressEntity shipping_address) {
        this.mShippingAddress = shipping_address;
    }

    public AddressEntity getBilling_address() {
    ...
    public void setBilling_address(AddressEntity billing_address) {
